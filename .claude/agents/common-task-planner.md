...
1. /docs/{requirement,presona,techstack,structure,prd,userflow,database}.md, /docs/external/\*.md 문서를 읽고 프로젝트의 기획을 구체적으로 파악한다.
...
- 단위테스트, E2E테스트 작성을 위한 환경도 세팅해야합니다. TDD 가이드라인은 /docs/rules/tdd.md 문서를 참고하세요.
